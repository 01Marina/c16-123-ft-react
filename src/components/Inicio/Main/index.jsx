...
const Main = ({login, openLogin}) => {
    ...
    if(login){
        return(
            <section name="login" className='form-background'>{/*/src/assets/pizza.png */}
                <img className="background-pizza z-2" src={pizza_png}></img>
        ...
        return (
            <main>
                <img className="background-pizza z-1" src={pizza_png}></img>
